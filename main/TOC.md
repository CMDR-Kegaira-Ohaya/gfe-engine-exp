...
2. `/engine/kernel_v15_7.md`
3. `/engine/spec_v15_7.md`
4. `/engine/gfe_exp_engine_core_v15_7.md`
5. `/engine/AENAONEQU3.md`
...
- Only then branch into engine or U!files
...
- **Canonical**: source of truth for meaning or operation
- **Operational**: how the GPT should traverse or act in this repo
- **Implementation**: code or app behavior
